...
public class Address {
  ...
  public Address(
    ...
    this.buildingChar = Pattern.matches("\\w", String.valueOf(buildingChar)) ? buildingChar : 1;
  }
   ...
   * @param buildingNumber Negative equals none
   */
  public Address(AddressType addressType, String addressName, int houseNumber, int buildingNumber) {
   ...
   */
  public Address(
      AddressType addressType, String addressName, int houseNumber, char buildingLetter) {
